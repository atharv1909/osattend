...
export default function StudentPage() {
  ...
  const submitAttendance = async () => {
    ...
    try {
      ...
      if (existingRoll) {
        throw new Error("Already marked! This roll number has already been registered.")
      }
      ...
      if (existingDevice) {
        throw new Error("Already marked! This device has already been used.")
      }
      ...
      if (insertError) {
        if (insertError.code === '23505') {
          throw new Error("Already marked! You have already registered for this session.")
        }
        throw insertError
      }
